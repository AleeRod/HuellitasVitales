    ...
    <div className="client-shell">
      <aside className="sidebar">
        <div className="sidebar-content">
          ...
          <a href="#vacunas" className="nav-link-client active" onClick={(e) => e.preventDefault()}>
          ...
          <div className="sidebar-pet-card">
            <div className="pet-mini">
              ...
              <div>
                ...
                <div className="pet-text">Sin vacunas registradas</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="main-content">
        <section className="topbar">
          <div>
            ...
            <h1 className="hero-title">Control de vacunas 💉</h1>
            <p className="hero-sub">Mantén un registro actualizado de las vacunas de tus mascotas.</p>
          </div>
            ...
            <div className="appointment-list">
              <div className="appointment" style={{ display: 'block', textAlign: 'center', padding: '3rem 1rem' }}>
                ...
                <p style={{ color: '#cbd5e0', fontSize: '.9rem', marginTop: '.5rem' }}>
                  El registro de vacunas aparecerá aquí cuando los veterinarios actualicen los datos de vacunación.
                </p>
              </div>
            </div>
          </div>
