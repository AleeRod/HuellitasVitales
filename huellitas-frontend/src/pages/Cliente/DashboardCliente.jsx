      ...
      <aside className="sidebar">
        <div className="sidebar-content">
          <div className="brand-card">
            <img src="/Imagenes/logo-huellitas.png" alt="Logo Huellitas Vitales" style={{ width: '80px', height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 8px 12px rgba(0,0,0,0.22))' }} />
            <div>
          ...
          <div className="content-card">
            <div className="card-head">
              <div>
                ...
                <p className="card-subtitle">Revisa las mascotas registradas en tu cuenta.</p>
              </div>
              <button className="btn-soft" onClick={() => navigate('/cliente/mis-mascotas')}>
                Ver todas
              </button>
            </div>
                ...
                return (
                  <div className="pet-item" key={mascotaId}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <button className="btn-soft" onClick={() => navigate('/cliente/mis-mascotas')} style={{ padding: '8px 10px' }}>Ver</button>
                    </div>
                  </div>
                );
              })}
